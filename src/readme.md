Lorem nice es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem nice ha
...
la creación de las hojas "Letraset", las cuales contenian pasajes de Lorem nice,
y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker,
el cual incluye versiones de Lorem nice.
